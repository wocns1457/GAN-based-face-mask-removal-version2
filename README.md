...
- Data Preprocessing : [MaskTheFace](https://github.com/aqeelanwar/MaskTheFace)
...
- Train
 ```
 python main.py --mode train  # If a checkpoint exists, training proceeds from the latest checkpoint.
 python main.py --mode train --choice_ckpt --m_ckpt_num 'num' --f_ckpt_num 'num' --d_ckpt_num 'num'  # If you want to train at a specific checkpoint.
 ```
- Test
 ```
 python main.py --mode test --dir_test ./test/test1.png  # Make predictions from the latest checkpoints.
 ```
